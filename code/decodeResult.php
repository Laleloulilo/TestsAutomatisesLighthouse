...
<table class="table">
    ...
    foreach ($arrayglobal as $valeur) {
        ...
        echo'<th scope="row" class="text-center '.$couleurGlobal.'">'.$global.'</th>';
        echo'<td class="text-center"><a href="./report/'.$rapport.'">📝</a></td>';
        echo'<td class="text-center '.$couleurPerformance.'">'.$performance.'</td>';
        echo'<td class="text-center '.$couleurAccessibilite.'">'.$accessibilite.'</td>';
        echo'<td class="text-center '.$couleurSeo.'">'.$seo.'</td>';
        echo'<td class="text-center '.$couleurBp.'">'.$bp.'</td>';
        echo'</tr>';
    }
